...
def error_400(error: object) -> object:
    """
    Render the 400.html template in the case of a 400 error (HTTP bad request)
...
def error_401(error: object) -> object:
    """
    Render the 401.html template in the case of a 401 error (unauthorized access to a page)
...
def error_404(error: object) -> object:
    """
    Render the 404.html template in the case of a 404 error (page not found)
...
def error_405(error: object) -> object:
    """
    Render the 405.html template in the case of a 405 error (HTTP method is not allowed)
